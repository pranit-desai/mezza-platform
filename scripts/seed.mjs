/**
 * Seeds Supabase with the V0 venue data.
 *
 * Usage:
 *   SUPABASE_URL=https://xwcqtemtisakdubgltjf.supabase.co \
 *   SUPABASE_SERVICE_ROLE_KEY=your_service_role_key \
 *   node scripts/seed.mjs
 *
 * Find your service role key: Supabase dashboard → Project Settings → API → service_role
 * Run once after deploying schema.sql.  Safe to re-run (upserts are idempotent).
 */
...
// Build groups from V0 decisions
const groupMap = {};
V0.forEach(v => {
